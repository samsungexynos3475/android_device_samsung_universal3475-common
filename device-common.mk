...
PRODUCT_COPY_FILES += \
    ...
    $(COMMON_PATH)/configs/permissions/privapp-permissions-cellbroadcast.xml:$(TARGET_COPY_OUT_SYSTEM_EXT)/etc/permissions/privapp-permissions-cellbroadcast.xml
